...
!      if (nload_traY_el.gt.0) allocate (val_traY_el(nload_traY_el,4), fun_traY_el(nload_traY_el))   
      if (nload_traZ_el.gt.0) allocate (val_traZ_el(nload_traZ_el,2), fun_traZ_el(nload_traZ_el))
      ...
      if (nload_forY_el.gt.0) allocate (val_forY_el(nload_forY_el,4), fun_forY_el(nload_forY_el))
      if (nload_forZ_el.gt.0) allocate (val_forZ_el(nload_forZ_el,4), fun_forZ_el(nload_forZ_el))
