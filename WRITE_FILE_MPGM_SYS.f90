...
!> @param[in] zr_mon monitor z-coordinate
      ...
      subroutine WRITE_FILE_MPGM_SYS(filec,nmon,n_mon,el_mon,xr_mon,yr_mon,zr_mon,axis_rot)
      ...
      real*8,dimension(nmon) :: axis_rot
      ...
      do i = 1,nmon
         write(20,'(1I20,1X,1I20,1X,1I20,1X,1E20.12,1X,1E20.12,1X,1E20.12,1X,1E20.12)') &
                                        i,n_mon(i),el_mon(i),&
                                        xr_mon(i),yr_mon(i),zr_mon(i),axis_rot(i)
      ...
      end subroutine WRITE_FILE_MPGM_SYS
