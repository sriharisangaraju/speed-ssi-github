...
!            MONITORXXXXXX.S (stress),MONITORXXXXXX.E (strain),MONITORXXXXXX.O (rot.) 
     ...
     if (option_out_var(1) .eq. 1) then
        write(unit_monitor1,*) variables_1
        close(unit_monitor1)
        deallocate(variables_1)
     endif   
     if (option_out_var(2) .eq. 1) then 
        write(unit_monitor2,*) variables_2
        close(unit_monitor2)
        deallocate(variables_2)
     endif   
     if (option_out_var(3) .eq. 1) then
        write(unit_monitor3,*) variables_3
        close(unit_monitor3)
        deallocate(variables_3)
     endif   
     if (option_out_var(4) .eq. 1) then
        write(unit_monitor4,*) variables_4
        close(unit_monitor4)
        deallocate(variables_4)
     endif   
     if (option_out_var(5) .eq. 1) then
        write(unit_monitor5,*) variables_5
        close(unit_monitor5)
        deallocate(variables_5)
     endif   
     if (option_out_var(6) .eq. 1) then
        write(unit_monitor6,*) variables_6
        close(unit_monitor6)
     ...
     if (dbg .eq. 1) then
        write(unit_monitor7,*) variables_7
        close(unit_monitor7)
        deallocate(variables_7)
        write(unit_monitor8,*) variables_8
        close(unit_monitor8)
