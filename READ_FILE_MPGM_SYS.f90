...
!> @param[in] SDOFnum number of monitors 
...
!> @param[out] zr_monitor_pgm z-coordinate for monitor
      ...
      subroutine READ_FILE_MPGM_SYS(filec,&
                        SDOFnum,n_monitor_pgm,el_monitor_pgm,&
                        xr_monitor_pgm,yr_monitor_pgm,zr_monitor_pgm,axis_rot)
      ...
      real*8,dimension(SDOFnum) :: axis_rot
        ...
        read(input_line(ileft:iright),*)SDOFnum
        ...
        do i = 1,SDOFnum
                ...
                read(input_line(ileft:iright),*)trash,n_monitor_pgm(i),el_monitor_pgm(i),&
                            xr_monitor_pgm(i),yr_monitor_pgm(i),zr_monitor_pgm(i),axis_rot(i)
      ...
      end subroutine READ_FILE_MPGM_SYS
