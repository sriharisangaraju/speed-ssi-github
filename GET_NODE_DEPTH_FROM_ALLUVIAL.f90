...
!> @brief Computes elevation from alluvial basin (ALL.out). 
...
!> @param[out] zz_elevation elevation of the nodes from alluvial
      ...
      integer*4 :: n_elev,nn_elem,cs_nnz_loc,nm,ne,nn_s
      ...
      z_elev_min = z_elev(1)
      do i = 1,n_elev
         if (z_elev(i).lt.z_elev_min) then
            z_elev_min = z_elev(i)
         endif
      enddo
                              ...
                              if (zz_s(ic).lt.z_elev_min) exit 
                                        ...
                                        if (zz_s(ic).ge.min(Z1,Z2,Z3)) then 
                                                ...
                                                ! Build up the plane passing through the points P1, P2 and P3
                                                        ...
                                                        zz_elevation(ic) = -1 * ( zz_interp - zz_s(ic) )
...
!      enddo
      ...
      end subroutine GET_NODE_DEPTH_FROM_ALLUVIAL
