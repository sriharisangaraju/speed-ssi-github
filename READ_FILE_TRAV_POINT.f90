...
!> @param[out] dist_monitor_pgm distance from first monitor

      subroutine READ_FILE_TRAV_POINT(filec,&
                        nmonitors_pgm,&
                        n_monitor_pgm,&
                        dist_monitor_pgm)
 ...
 !     read(*,*)
      ...
      do i = 1,nmonitors_pgm
         ...
         ileft = 1
         iright = len(input_line)
         read(input_line(ileft:iright),*) trash, n_monitor_pgm(i), trash_real, trash_real, trash_real, dist_monitor_pgm(i)
      ...
      end subroutine READ_FILE_TRAV_POINT
